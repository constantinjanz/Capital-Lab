...
Durable calendar-aware decision-cycle wiring, calendars beyond 2026, remote scheduling, and production activation remain deferred. The manual Alpaca batch still does not call Alpaca's calendar because that endpoint is on a trading host and cannot create or alter a market-session row.
