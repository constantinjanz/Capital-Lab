...
const allowedTransitions: Readonly<Record<ActivationState, ActivationState[]>> =
  {
    ...
    jobs_installed_disabled: ['auth_endpoint_verified', 'failed', 'aborted'],
    auth_endpoint_verified: [
      'auth_failure_probes_claimed',
      'failed',
      'aborted',
    ...
    auth_failures_verified: ['auth_noop_claimed', 'failed', 'aborted'],
    auth_noop_claimed: ['auth_noop_verified', 'failed', 'aborted'],
    auth_noop_verified: ['runtime_deployment_verified', 'failed', 'aborted'],
    runtime_deployment_verified: ['baseline_frozen', 'failed', 'aborted'],
