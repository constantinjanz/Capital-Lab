...
export const activationStates = [
  ...
  'auth_endpoint_verified',
  'auth_failure_probes_claimed',
  'auth_failures_verified',
  'auth_noop_claimed',
  'auth_noop_verified',
  'runtime_identity_verified',
  'runtime_config_attestation_requested',
...
const allowedTransitions: Readonly<Record<ActivationState, ActivationState[]>> =
  {
    prepared: ['infra_installed', 'failed', 'inconclusive', 'aborted'],
    infra_installed: ['vault_verified', 'failed', 'inconclusive', 'aborted'],
    vault_verified: [
      'jobs_installed_disabled',
      'failed',
      'inconclusive',
    ...
    baseline_frozen: ['armed', 'failed', 'inconclusive', 'aborted'],
    armed: ['running', 'failed', 'inconclusive', 'aborted'],
    running: ['auto_stopped', 'failed', 'inconclusive', 'aborted'],
    auto_stopped: ['reconciled', 'failed', 'inconclusive', 'aborted'],
    reconciled: ['passed', 'failed', 'inconclusive', 'aborted'],
    passed: [],
    failed: [],
    inconclusive: [],
    aborted: [],
